...
<Input type="number" fontWeight={player.scores[currentHole] === 1 ? 'bold' : 'normal'} color={player.scores[currentHole] === 1 ? 'red' : 'green.500'} value={player.scores[currentHole] === 0 ? "" : player.scores[currentHole]} onChange={(e) => handleScoreChange(playerIndex, currentHole, e.target.value)} size="sm" max={9} />
                </Td>
              ))}
            </Tr>
            <Tr>
...
<Input type="number" fontWeight={player.scores[holeIndex] === 1 ? 'bold' : 'normal'} color={player.scores[holeIndex] === 1 ? 'red' : 'gray.500'} value={player.scores[holeIndex] === 0 ? "" : player.scores[holeIndex]} onChange={(e) => handleScoreChange(playerIndex, holeIndex, e.target.value)} size="sm" max={9} />
                    </Td>
                  ))}
                </Tr>
              );
